...
function Component4() {
  return (
    <div className="">
      <div className="w-full h-auto bg-violet-900 py-16">
        ...
        <div className="flex items-center justify-center mt-6">
          <div className="">
            ...
            <img src={frame} className="float-right" />
          </div>
          <div className="">
            <Trending img={img10} />
      ...
      <div className="flex justify-between px-32">
        <div className="mt-32  ">
          ...
          <p className="w-96 text-left mt-2 text-zinc-800 text-base font-normal font-['Poppins'] leading-relaxed">
            Fusce venenatis tellus a felis scelerisque, non <br /> pulvinar est
            pellentesque.
          </p>
      ...
      <div className="w-auto mt-32 h-72 bg-violet-900 rounded-3xl">
        <div className="flex justify-between relative items-center">
          <img src={agent} className="mb-60 absolute " />
          <div className="py-44 mx-auto mb-10 ">
          ...
          <div className="w-40 h-12 px-7 py-5 bg-white rounded-3xl border border-violet-900 justify-start items-center gap-2.5 inline-flex">
